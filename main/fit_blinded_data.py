...
if __name__ == '__main__':
    ...
    if args.zrange is None:
        for tr in args.tracers:
            for zmin, zmax in REDSHIFT_BIN_LSS[tr]:
        ...
        if approach in ['FM', 'SF']:
            ...
            if use_emulator:
                ...
                if not os.path.exists(emulator_fn):
                    ...
                    fit_args = {"corr_type":corr_type, "bins_type":bins_type, "cov_type":'covfn', "option":option}
                ...
                fit_args = {"corr_type":corr_type, "bins_type":bins_type, "cov_type":'covfn', "emulator_fn": emulator_fn,"option":option}
            else: 
